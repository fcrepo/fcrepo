...
@PropertySources({
        ...
        @PropertySource(value = BasePropsConfig.VERSION_PROPERTIES, ignoreResourceNotFound = true)
})
abstract class BasePropsConfig {
    ...
    public static final String VERSION_PROPERTIES = "classpath:fcrepo-version.properties";

...
public class FedoraResourceIT extends AbstractIT {
	...
	public void testDatastreamGraph() throws IOException, RepositoryException, InvalidChecksumException {
        ...
        assertTrue(propertiesDataset.getContext().isDefined(Symbol.create("uri")));
    ...
    public void testUpdatingObjectGraph() throws RepositoryException {
        ...
        object.updatePropertiesDataset("INSERT { <info:fedora/testObjectGraphUpdates> <info:fcrepo/zyx> \"a\" } WHERE {} ");
        ...
        object.updatePropertiesDataset("DELETE { <info:fedora/testObjectGraphUpdates> <info:fcrepo/zyx> ?o }\nINSERT { <info:fedora/testObjectGraphUpdates> <info:fcrepo/zyx> \"b\" } WHERE { <info:fedora/testObjectGraphUpdates> <info:fcrepo/zyx> ?o } ");

        assertFalse("found value we should have removed", object.getPropertiesDataset().asDatasetGraph().contains(Node.ANY, s, p, o));
        o = Node.createLiteral("b");
        assertTrue("could not find new value", object.getPropertiesDataset().asDatasetGraph().contains(Node.ANY, s, p, o));

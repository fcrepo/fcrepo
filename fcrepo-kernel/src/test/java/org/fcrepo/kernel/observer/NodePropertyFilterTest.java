...
import org.fcrepo.kernel.observer.NodePropertyFilter;
...
public class NodePropertyFilterTest {

    private NodePropertyFilter testObj;
    ...
    public void setUp() throws Exception {
        initMocks(this);
        testObj = new NodePropertyFilter();
        final Field repoF = NodePropertyFilter.class.getDeclaredField("repository");

...
public class TestHelpers {
    ...
    public static DatastreamIterator mockDatastreamIterator(String pid,
            String dsId, String content) throws RepositoryException,
            IOException {
    ...
    public static Datastream mockDatastream(String pid, String dsId,
            String content) {
    ...
    public static PropertyIterator
            getPropertyIterator(int numValues, long size) {

...
public class LowLevelCacheEntryTest {
    ...
    public void setUp() throws Exception {
        ...
        testIspnObj = new LowLevelCacheEntry(mockIspnStore, mockLowLevelCacheStore, testKey);
    }
    ...
    public void shouldBeEqualIfTheKeyStoreAndCacheStoreAreEqual() throws Exception {
        ...
        LowLevelCacheEntry ispnObject = new LowLevelCacheEntry(mockStore, mockCacheStore, testKey);
        LowLevelCacheEntry otherObj = mock(LowLevelCacheEntry.class);
    ...
    public void testStoreValue() throws Exception {
        ...
        when(mockLowLevelCacheStore.getCacheStoreConfig()).thenReturn(mockConfig);
        LowLevelCacheEntry ispnEntry = 
        		new LowLevelCacheEntry(mockIspnStore, mockLowLevelCacheStore, testKey);
    ...
    public void testFileSystemExternalIdentifier() throws Exception {
        ...
        LowLevelCacheEntry filesystemTestObj = new LowLevelCacheEntry(fsbs, testKey);

...
/**
 * Unit test for ReindexResourceOperationBuilder
 *
 * @author bbpennel
 */
public class ReindexResourceOperationBuilderTest {
    ...
    public void buildTest() {
        ...
        final var builder = new ReindexResourceOperationBuilder(tx, resourceId);

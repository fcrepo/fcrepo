...
public class PropertiesRdfContextTest {
    ...
    @Test
    public void testNonRdfSourceDescriptionProperites() throws RepositoryException {
        // Verify that properties from the Binary resource are included on requests for NonRdfSourceDescription
        // resources
    }

    @Test
    public void testFedoraBinaryProperites() throws RepositoryException {
        // Verify that the properties on the NonRdfSourceDescription resource are included on requests for Binary
        // resources
    }

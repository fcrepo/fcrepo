...
CREATE INDEX IF NOT EXISTS membership_tx_operations_idx1
    ON reference_transaction_operations (object_id, transaction_id, operation);

-- Create an index to speed finding records related to a transaction.
CREATE INDEX IF NOT EXISTS rmembership_tx_operations_idx2
